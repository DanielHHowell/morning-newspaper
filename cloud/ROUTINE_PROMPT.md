...
Steps:
1. Pre-gather: `TODAY=$(TZ=America/Chicago date +%F)`; `python3 bin/weather.py 78745`, `python3 bin/markets.py` and `python3 bin/feeds.py` (all key-free; if one fails, note it and continue).
